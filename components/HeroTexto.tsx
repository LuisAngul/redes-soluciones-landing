...
export default function HeroTexto() {
  return (
    <div>
      ...
      <h1 className="mt-6 max-w-[20ch] text-[34px] font-bold leading-tight tracking-tight text-blanco md:text-[60px]">
      ...
      <motion.p
        ...
        className="mt-6 max-w-[68ch] text-[17px] leading-relaxed text-blanco/75"
      >
